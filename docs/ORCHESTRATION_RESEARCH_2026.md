...
jleechanbrain orchestration design doc (`roadmap/ORCHESTRATION_DESIGN.md`).
...
The jleechanbrain rejection of Gastown is defensible. The key distinction:
...
**Risk for jleechanbrain design:** Agent Teams may eventually subsume what ai_orch does,
...
## 6. Risks Identified for jleechanbrain Architecture
...
### Why agent-orchestrator Wins for jleechanbrain
