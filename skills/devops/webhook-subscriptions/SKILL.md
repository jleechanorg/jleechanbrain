...
- Subscriptions persist to `~/.smartclaw/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/.smartclaw/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.smartclaw/logs/gateway.log | tail -20`
