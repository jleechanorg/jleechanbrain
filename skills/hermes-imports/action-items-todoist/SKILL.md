...
- **Read and follow `~/executive-assistant-skills/skills/email-drafting/SKILL.md`** — it is the single source of truth for all drafting rules, style, templates, humanization, and delivery
