...
for plist in "$LAUNCHD_TEMPLATES_DIR"/ai.smartclaw.schedule.*.plist.template "$LAUNCHD_TEMPLATES_DIR"/ai.smartclaw.schedule.*.plist.template; do
  [[ -f "$plist" ]] || continue
...
for plist in "$LAUNCHD_TEMPLATES_DIR"/ai.smartclaw.schedule.*.plist "$LAUNCHD_TEMPLATES_DIR"/ai.smartclaw.schedule.*.plist; do
  [[ -f "$plist" ]] || continue
