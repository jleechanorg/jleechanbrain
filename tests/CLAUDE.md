...
| `test_hermes_notifier.py` | Outbox enqueue, drain atomicity, notify_hermes fallback |
...
## Hermes Config: This Repo IS the Live Config
...
```bash
launchctl stop gui/$UID/ai.smartclaw.prod
launchctl start gui/$UID/ai.smartclaw.prod
```
